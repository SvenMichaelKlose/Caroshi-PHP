...
class list_records extends application {
  ...
  function defaultview ()
  {
    ...
    $ui->link ('Neuen Eintrag erstellen', new event ('person_erstellen'));
  ...
  function person_editieren ()
  {
    ...
    $ui->link ('zur&uuml;ck', new event ('defaultview'));
  ...
  function person_erstellen ()
  {
    ...
    $arg = array ('next_view' => new event ('person_editieren'), 'ret' => 'id');
